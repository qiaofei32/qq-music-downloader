...
class Handlers
{
    ...
    */
    ...
    public static RulesOption("Hide JS")
    BindPref("fiddlerscript.rules.HideJs")
    var m_HideJs: boolean = false;	
        
    public static RulesOption("Hide Woff")
    BindPref("fiddlerscript.rules.HideWoff")
    var m_HideWoff: boolean = false;	       
        
	
    public static RulesOption("Hide 404s")
    BindPref("fiddlerscript.rules.Hide404s")
    var m_Hide404s: boolean = false;
    ...
    public static RulesOption("Hide All")
    BindPref("fiddlerscript.rules.HideAll")
    var m_HideAll: boolean = false;             
...
//    var m_Japanese: boolean = false;
    ...
    RulesStringValue(17,"&Firefox 27", "Mozilla/5.0 (Windows NT 6.3; WOW64; rv:27.0) Gecko/20100101 Firefox/27.0")
    ...
    RulesStringValue(20,"Chrome", "Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.58 Safari/537.36")
...
*/
    ...
    static function OnBeforeResponse(oSession: Session) {
        ...
        if (m_Hide404s && oSession.responseCode == 404) {
            oSession["ui-hide"] = "true";
        }		
        if (m_HideCss && (oSession.url.EndsWith(".css") || oSession.oResponse.headers.ExistsAndContains("Content-Type", "text/css")))
		{
            oSession["ui-hide"] = "true";
        }
        if (m_HideJs && (oSession.url.EndsWith(".js")|| oSession.oResponse.headers.ExistsAndContains("Content-Type", "application/x-javascript") || oSession.oResponse.headers.ExistsAndContains("Content-Type", "application/javascript")  || oSession.oResponse.headers.ExistsAndContains("Content-Type", "text/javascript") ) ) {
            oSession["ui-hide"] = "true";
        }
        
        if (m_HideWoff && (oSession.url.EndsWith(".woff")|| oSession.oResponse.headers.ExistsAndContains("Content-Type", "application/x-font-woff")  )) {
            oSession["ui-hide"] = "true";
        }
